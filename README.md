# FlipperHTTP
HTTP library for Flipper Zero. Compatible with WiFi Developer Board for Flipper Zero (ESP32S2 Dev Module). View the extended documentation here: https://www.jblanked.com/api/FlipperHTTP/
