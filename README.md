# FlipperHTTP
HTTP library for Flipper Zero. Compatible with the WiFi Developer Board, Raspberry Pi Pico W, and other ESP32 devices. View the extended documentation here: https://www.jblanked.com/api/FlipperHTTP/
